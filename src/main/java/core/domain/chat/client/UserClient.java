...
import core.domain.chat.dto.UpsertChatRoomImageRequest;
...
public interface UserClient {
    ...
    @PostMapping("/api/v1/images/chat-rooms")
    void upsertChatRoomImage(@RequestBody UpsertChatRoomImageRequest request);
}